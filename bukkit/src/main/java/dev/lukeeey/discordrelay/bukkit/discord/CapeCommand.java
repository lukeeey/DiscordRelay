...
public class CapeCommand extends DiscordCommand {
    private final DiscordRelayPlatform platform;

    public CapeCommand(DiscordRelayPlatform platform) {
        super("cape", "Display a players cape texture");
    ...
    public void execute(Member sender, TextChannel channel, String[] args) {
        ...
        EmbedBuilder builder = new EmbedBuilder()
                .setTitle(target.getName() + "'s cape")
                .setImage("https://crafatar.com/capes/" + target.getUniqueId().toString());
