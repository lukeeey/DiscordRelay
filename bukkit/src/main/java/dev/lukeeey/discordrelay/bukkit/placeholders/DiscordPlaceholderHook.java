package dev.lukeeey.discordrelay.bukkit.placeholders;

import dev.lukeeey.discordrelay.bukkit.DiscordRelayBukkit;
...
public class DiscordPlaceholderHook extends PlaceholderExpansion {
    ...
    private String _onPlaceholderRequest(Player player, String identifier) {
        DiscordRelayBukkit plugin =  DiscordRelayBukkit.getInstance();
        TextChannel relayChannel = plugin.getPlatform().getRelayChannel();
        ...
        switch (identifier) {
            ...
            case "guild_max_emotes":
                return String.valueOf(relayChannel.getGuild().getMaxEmojis());
    ...
    public @NotNull String getVersion() {
        String version = DiscordRelayBukkit.class.getPackage().getImplementationVersion();
