...
public class SkinCommand extends DiscordCommand {
    private final DiscordRelayPlatform platform;

    public SkinCommand(DiscordRelayPlatform platform) {
        super("skin", "Display a players skin texture");
    ...
    public void execute(Member sender, TextChannel channel, String[] args) {
        ...
        EmbedBuilder builder = new EmbedBuilder()
                .setTitle(target.getName() + "'s skin")
                .setImage("https://crafatar.com/skins/" + target.getUniqueId().toString());
